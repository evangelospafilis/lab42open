...
### Track 3: Autonomous AI agents for global microbial metabolic mapping under climate change
...
* **Ideal Skills:** 
    * `Python`
    * LLM inference engine and orchestration frameworks (e.g. `Ollama` and `PicoClaw`)
